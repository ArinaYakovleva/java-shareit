...
public class RequestServiceImpl implements RequestService {
    ...
    public RequestDto addRequest(CreateRequestDto requestDto, Long userId) {
        ...
        log.info(String.format("Добавление запроса: %s", requestDto.toString()));
    ...
    public List<RequestDto> getAllRequests(Integer from, Integer to, Long userId) {
        ...
        return requestRepository.findAllByOtherUsers(userId, pageRequest)
                .stream().map(this::getRequestDto)
                .collect(Collectors.toList());
    }
